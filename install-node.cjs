'use strict';
  ...
  async function main() {
    console.log('\n[!] OpenClaw Mechanicus Installer');
    var root = detectOpenClaw();
    if (!root) {
      console.error('[X] ERROR: OpenClaw folder not found.');
      process.exit(1);
    }
